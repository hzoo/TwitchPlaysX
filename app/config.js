...
var programName =
  process.env.CONFIG_PROGRAM_NAME || nconf.get("CONFIG_PROGRAM_NAME");
var maxCharName =
  process.env.CONFIG_MAX_CHAR_NAME || nconf.get("CONFIG_MAX_CHAR_NAME");
var maxCharCommand =
  process.env.CONFIG_MAX_CHAR_COMMAND || nconf.get("CONFIG_MAX_CHAR_COMMAND");
...
var filteredCommands =
  process.env.CONFIG_FILTERED_COMMANDS || nconf.get("CONFIG_FILTERED_COMMANDS");
var throttledCommands =
  process.env.CONFIG_THROTTLED_COMMANDS ||
  nconf.get("CONFIG_THROTTLED_COMMANDS");
